          ...
          <div class="contact-form box-shadow border-radius-8">
            <div class="breadcrumbs desktop-only">
              <ul class="inline-list">
                ...
                <li>
                  <nuxt-link to="/partnerbijdrage/">partnerbijdrage</nuxt-link><span class="right-angel">&gt;</span>
                </li>
                <li>
                  {{ blogDetails.slug }}
                </li>
                ...
                <div class="sidebar">
                  ...
                  <div id="news_list">
                    <div class="card mobile-col-2 other-news box-shadow border-radius-8"
                      v-for="(item, i) in recentBlogs" :key="i">
                      <div class="card-thumb">
                        <img class="blog_thumb" :src="backend + '/' + item.images" alt="nieuws image">
                      </div>
                      <div class="card-content">

                        <h2>
                          <router-link :to="'/partnerbijdrage/' + item.slug + '/' + item.id">{{ item.blog_title.length >
                              25
